export function sendResetPasswordEmailTemplate(verificationCode: string): string {
  return `<!DOCTYPE html>
  <html lang="ko">
    <head>
      <meta charset="UTF-8" />
    ...
    <body style="font-family: 'Pretendard', sans-serif; margin: 0; padding: 20px; background-color: #f5f5f5;">
      <div
        ...
        "
      >
        <h2 style="font-size: 1.5rem; color: #89D9E9;">TODO HUNTER 비밀번호 재설정 인증코드 안내입니다.</h2>

        <div style="margin: 3.75rem 0;">
          <p style="font-size: 0.875rem; margin-bottom: 0.625rem;">안녕하세요.</p>
          <p style="font-size: 0.875rem; margin-bottom: 0.625rem;">비밀번호 재설정을 위한 인증 코드가 생성되었습니다.</p>
          <p style="font-size: 0.875rem; margin-bottom: 0.625rem;">
            아래 <strong style="color: #89D9E9;">'인증 코드'</strong>를 입력하여 본인 인증 후 새 비밀번호를 설정해주세요.
          </p>
          <p style="font-size: 0.875rem; margin-bottom: 0.625rem; color: #888;">
